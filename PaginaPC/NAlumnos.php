...
<body>
    ...
    <div class="tabla">
        <table>
            ...
            <?php
                ...
                // Obtener las notas y la materia
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='7' class='no-datos'>No hay datos disponibles</td></tr>";
                }
    ...
    <script>
        async function obtenerYActualizarNotas(materia) {
            try {
                const response = await fetch('obtener_notas.php?materia=' + materia);
                const data = await response.json();

                document.getElementById('parcial1_' + materia.charAt(0)).innerText = data.Parcial1 || 'N/A';
                document.getElementById('parcial2_' + materia.charAt(0)).innerText = data.Parcial2 || 'N/A';
                document.getElementById('parcial3_' + materia.charAt(0)).innerText = data.Parcial3 || 'N/A';
                document.getElementById('parcial4_' + materia.charAt(0)).innerText = data.Parcial4 || 'N/A';
                document.getElementById('final_' + materia.charAt(0)).innerText = data.Final || 'N/A';
            } catch (error) {
