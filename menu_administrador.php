<?php
// Este archivo contiene el menú del administrador que puede ser incluido en otras páginas
?>
                            ...
                            <g id="-Round-/-Navigation-/-arrow_back_ios" transform="translate(442.000000, 54.000000)">
                                <g>
                                    ...
                                    <path
                                        ...
                                        id="馃敼-Icon-Color" fill="#1D1D1D"></path>
                                </g>
                            </g>
                        </g>
                    </g>
...
<script>
    // Funcionalidad del menú del administrador
    function goBack() {
        window.history.back();
    }
